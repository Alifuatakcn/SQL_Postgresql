...
SELECT * FROM staff WHERE id BETWEEN '1003' and '1005';
-D ile Y arasındaki personel bilgilerini listeleyiniz
SELECT * FROM staff WHERE isim BETWEEN 'D' and 'Y';
-D ile Y arasında olmayan personel bilgilerini listeleyiniz
SELECT * FROM staff WHERE isim NOT BETWEEN 'D' and 'Y';
-Maaşı 70000 ve ismi Sena olan personeli listeleyiniz
SELECT * FROM staff WHERE isim='Sena' or maas='70000';
